...
bconc, bconceal, blip, bperc, btrack = stats_choice[5] + skills_all[0], stats_choice[0] + skills_all[1], stats_choice[
    0] + skills_all[2], stats_choice[0] + skills_all[3], stats_choice[0] + skills_all[4]
...
stats_choice[0] + skills_all[15], stats_choice[0] + skills_all[16], stats_choice[0] + skills_all[17], stats_choice[0] + \
skills_all[18], stats_choice[0] + skills_all[19], stats_choice[0] + skills_all[20], stats_choice[0] + skills_all[21], \
stats_choice[0] + skills_all[22], stats_choice[0] + skills_all[23], stats_choice[0] + skills_all[24], stats_choice[0] + \
skills_all[25], stats_choice[0] + skills_all[26], stats_choice[0] + skills_all[27], stats_choice[0] + skills_all[28], \
...
bbribe, bconvo, bhuman_perc, binterog, bpers, bpersonal_grooming, bstreetwise, btrading, bward_n_style = stats_choice[
                                                                                                             4] + \
                                                                                                         skills_all[42], \
                                                                                                         stats_choice[
                                                                                                             9] + \
...
stats_choice[3] + skills_all[51], stats_choice[3] + skills_all[52], stats_choice[3] + skills_all[53], stats_choice[3] + \
skills_all[54], stats_choice[3] + skills_all[55], stats_choice[3] + skills_all[56], stats_choice[3] + skills_all[57], \
stats_choice[3] + skills_all[58], stats_choice[3] + skills_all[59], stats_choice[3] + skills_all[60], stats_choice[3] + \
skills_all[61], stats_choice[3] + skills_all[62], stats_choice[3] + skills_all[63], stats_choice[3] + skills_all[64], \
...
def drawMyImage():
    ...
    if part == 1:
        ...
        if part == 2:
            draw = ImageDraw.Draw(image_second_page)

def readvalues():
    global stats_choice, intel, ref, dex, tech, cool, will, luck, move, body, emp, role_choice, statEntry,skillEntry,charname,part
    ...
    for i in range(65):
        if i == 12 or i == 38 or i == 33 or i == 54 or i == 55 or i == 59 or i == 38 or i == 40:
            totalSkills += int(skillEntry[i].get())*2
        else:
            totalSkills += int(skillEntry[i].get())


    tk.Label(root, text=f'Total Stat Points: {totalStats}').grid(row=13, column=1)

    tk.Label(root, text=f'Total Skill Points: {totalSkills}. You may leave some skills at 0.').grid(row=14, column=1)
    ...
    if totalSkills == 86:
        ...
        errorskills = "Your Skill level total exceeds 64. Please reallocate your stats."
        ...
        errorskills = "Your Skill level total is below 64. Please reallocate your stats."
        skillserror = Message(root, text=errorskills)
        skillserror.config(bg="red")
        skillserror.grid(row=22, column=1)
        buttonskills = tk.Button(root, text="OK", command=lambda: [skillserror.destroy(), buttonskills.destroy()])
...
def gearshopping():
    ...
    tk.Label(gear, text="Gearshopping").grid(row=0, column=1)
    gear.mainloop()
